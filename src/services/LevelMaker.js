...
export default class LevelMaker {
  ...
  static levelOne() {
    const blocks = [
      new Block(
        LevelMaker.START_X +
          Block.SPRITE_MEASUREMENTS[Size.Medium].width * 0.25,
        CANVAS_HEIGHT -
          Ground.GRASS.height -
      ...
      new Block(
        LevelMaker.START_X +
          Block.SPRITE_MEASUREMENTS[Size.Medium].width * 4.75,
        CANVAS_HEIGHT -
          Ground.GRASS.height -
          Block.SPRITE_MEASUREMENTS[Size.Medium].height,
        Size.Medium
      ...
      new Block(
        LevelMaker.START_X + Block.SPRITE_MEASUREMENTS[Size.Medium].width * 2.5,
        CANVAS_HEIGHT -
          Ground.GRASS.height -
          Block.SPRITE_MEASUREMENTS[Size.Medium].height * 2,
        Size.Large,
    ...
    const birdQueue = new BirdQueue([BirdType.Yellow, BirdType.Red]);
  ...
  static levelTwo() {
    const blocks = [
      ...
      new Block(
        ...
        CANVAS_HEIGHT -
          Ground.GRASS.height -
          Block.SPRITE_MEASUREMENTS[Size.Medium].height * 3,
        Size.Large,
        Block.ANGLE_HORIZONTAL
      ),
    ];
    ...
    const pigs = [
      new Pig(LevelMaker.START_X + 110, CANVAS_HEIGHT - Ground.GRASS.height),
      new Pig(
        LevelMaker.START_X + 110,
        CANVAS_HEIGHT -
          Ground.GRASS.height -
          Pig.SPRITE_MEASUREMENTS[0].height * 3
      ),
      new Pig(
        LevelMaker.START_X + 110,
        CANVAS_HEIGHT -
          Ground.GRASS.height -
          Pig.SPRITE_MEASUREMENTS[0].height * 5
      ),
    ];

    const birdQueue = new BirdQueue([
      BirdType.Red,
      BirdType.Red,
      BirdType.Red,
      BirdType.Red,
  ...
  static levelThree() {
    const blocks = [
      ...
      new Block(
        LevelMaker.START_X - 100,
        CANVAS_HEIGHT -
          Ground.GRASS.height -
          Block.SPRITE_MEASUREMENTS[Size.Medium].height,
        Size.Large,
        Block.ANGLE_RIGHT_DIAGONAL
      ),
      new Block(
        LevelMaker.START_X + Block.SPRITE_MEASUREMENTS[Size.Medium].width * 8,
        CANVAS_HEIGHT -
          Ground.GRASS.height -
          Block.SPRITE_MEASUREMENTS[Size.Medium].height,
        Size.Large,
        Block.ANGLE_LEFT_DIAGONAL
      ),
    ];
